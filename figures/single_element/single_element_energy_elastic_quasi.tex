...
\addplot[blue,          thick, dashed] table[col sep=comma, x=time, y=psie_active_int]{data/single_element/elastic_qs/old/pull_test_restart_out_nu_0p30_old.csv};
\addplot[violet,        thick, dashed] table[col sep=comma, x=time, y=psie_active_int]{data/single_element/elastic_qs/old/pull_test_restart_out_nu_0p499_old.csv};
...
\addplot[blue,          thick, dashed] table[col sep=comma, x=time, y=psie_active_int]{data/single_element/elastic_qs/new/pull_test_restart_out_nu_0p30_new.csv};
\addplot[violet,        thick, dashed] table[col sep=comma, x=time, y=psie_active_int]{data/single_element/elastic_qs/new/pull_test_restart_out_nu_0p499_new.csv};
\draw[black!50, dashed] (axis cs:1.0,0) -- (axis cs:1.0,0.012);
\node[above, font=\tiny, rotate=90] at (axis cs:0.97,0.002) {restart};

\end{groupplot}
\end{tikzpicture}
\caption{Single element, quasi-static-elastic: Integrated elastic energy vs.\ time for method \#1 (left) and method \#2 (right). Solid lines: reference. Dashed lines: restart. Legend in left panel applies to both.}
